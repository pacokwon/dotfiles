...
require('lazy').setup({
...

  {
    'tpope/vim-fugitive',
    keys = {
      { '<leader>gg', '<cmd>vertical Git<CR>', silent = true },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sg', builtin.find_files, { desc = '[S]earch Files Respecting .[G]itignore' })
